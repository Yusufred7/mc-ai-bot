...
http.createServer((req, res) => res.end('Bedrock Botu Aktif!')).listen(process.env.PORT || 3000);
...
// Bedrock Sunucusuna Tam Sürüm Bağlantısı
const client = bedrock.createClient({
  host: process.env.MC_HOST,
  port: parseInt(process.env.MC_PORT) || 19132,
  username: 'AIBot_Bedrock',
  offline: true,
  version: '1.20.30' // Oynadığın 1.20.31 sürümüne uygun protokol
});
